...
export default function OfflinePage() {
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-[#0B1220] px-6 text-center text-white">
      <div className="mb-5 flex h-14 w-14 items-center justify-center rounded-2xl border border-white/[0.08] bg-white/[0.03] text-white/60">
      ...
      <div className="grid w-full max-w-md gap-3 sm:grid-cols-2">
        <Link
          ...
          className="group flex items-center gap-3 rounded-xl border border-white/[0.08] bg-white/[0.025] p-4 text-left transition-colors hover:border-[#2DD4A8]/25 hover:bg-white/[0.04]"
        >
          <Calculator className="h-5 w-5 shrink-0 text-[#2DD4A8]" strokeWidth={1.75} />
          <span className="flex-1 text-sm font-medium">Calculator</span>
          <ArrowRight className="h-4 w-4 text-[#2DD4A8]/70 transition-transform group-hover:translate-x-0.5" />
        </Link>
        <Link
          href="/catalog"
          className="group flex items-center gap-3 rounded-xl border border-white/[0.08] bg-white/[0.025] p-4 text-left transition-colors hover:border-[#2DD4A8]/25 hover:bg-white/[0.04]"
        >
          <BookText className="h-5 w-5 shrink-0 text-[#2DD4A8]" strokeWidth={1.75} />
